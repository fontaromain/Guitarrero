...
#ifndef _GUINOLEVELSPAGE_H_
#define _GUINOLEVELSPAGE_H_

#include "include.h"
#include "GuiPage.h"

class GuiNoLevelsPage : public GuiPage
{
	public :
		GuiNoLevelsPage(irr::scene::ISceneManager* baseSmgr, irr::video::IVideoDriver* driver, Ressources* ressources) ;
